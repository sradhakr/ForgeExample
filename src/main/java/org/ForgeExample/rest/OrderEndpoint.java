...
public class OrderEndpoint {
	...
	public Response findById(@PathParam("id") Long id) {
		TypedQuery<Order> findByIdQuery = em
				.createQuery(
						"SELECT DISTINCT o FROM Order o WHERE o.id = :entityId ORDER BY o.id",
						Order.class);
	...
	@GET
	@Produces("application/json")
	public List<Order> listAll(@QueryParam("start") Integer startPosition,
			@QueryParam("max") Integer maxResult) {
		TypedQuery<Order> findAllQuery = em.createQuery(
				"SELECT DISTINCT o FROM Order o ORDER BY o.id", Order.class);
